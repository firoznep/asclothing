      ...
      txn.executeSql(
        ...
        function (tx, res) {
          ...
          if (res.rows.length == 0) {
            ...
            txn.executeSql(
              'CREATE TABLE IF NOT EXISTS stock_table(item_id INTEGER PRIMARY KEY AUTOINCREMENT, date VARCHAR(50), item_name VARCHAR(50), item_color VARCHAR(20), item_size VARCHAR(20), quantity INT(10), unit VARCHAR(20), unit_rate INT(10),total_amount INT(50), description VARCHAR(255))',
              [],
              (tx, res) => {
